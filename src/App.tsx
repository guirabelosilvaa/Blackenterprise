...
export default function App() {
  // Default to fuel on mobile view, workspace on desktop view
  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] text-[#ececec] flex flex-col selection:bg-[#333338] selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      {/* Floating Navigation Dock: Oculto no celular (sem abas), visível no computador com todas as páginas */}
      {!isMobile && (
        <nav
